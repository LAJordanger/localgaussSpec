...
TS_families <-
    list(WNG = list(package = "stats",
         ...
         rmvnorm = list(package = "mvtnorm",
                        ...
                        size_name = "n")
         ## ,
         ## fGarch = list(package = "fGarch",
         ##               fun = "garchSim",
         ##               args = list(spec = quote(fGarch::garchSpec()),
         ##                           n.start = 100,
         ##                        extended = FALSE),
         ##               size_name = "n"),
...
TS_families <- c(
    TS_families,
    list(wacky  =  list(package = "LocalCode",
                       fun = "wacky_sample",
                       args = list(omega = 0.2,
                                   delta = 1,
                                   seed = 1,
