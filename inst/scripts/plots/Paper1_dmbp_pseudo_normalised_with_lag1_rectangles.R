...
###  Create a version that contains the bands of interest, i.e. need to have a data-frame 
...
##  about the number of points within these squares might also be of interest.
...
.save_file <- file.path("~/Dropbox/arXiv/Article_1_JASA/figure",
                        "dmbp_pseudo_normalised_with_rectangles-1.pdf")
