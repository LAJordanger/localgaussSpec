...
##  This scripts investigates the first 20 local Gaussian
##  cross-correlations, based on a multivariate GARCH-type model
##  fitted to the log-returns of the EuStockMarkets-data, focusing on
##  the variables corresponding to the original DAX and CAC variables.
