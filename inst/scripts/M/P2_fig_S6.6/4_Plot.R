###----------------------------------------------------------------###
##  The EuStockMarkets-example from P2_fig_S6.6, focusing on the DAX-
...
##  point v varies along the diagonal in the extreme lower tail.

#####------------------------------------------------------------#####

##  In order for this script to work, it is necessary that the script
## '2_Data.R' from P2_fig_S6.4 has been used first.
...
##  Adjust the y-scale to better see the result
heatmap_plot <- heatmap_plot + ylim(0,0.04)
