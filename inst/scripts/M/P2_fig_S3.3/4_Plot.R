...
##  adjustment, from P2_fig_S3.3.


##  This script generates a plot that combines heatmap-based plot for
##  the Amplitude- and Phase-spectra with the corresponding
##  distance-based plot.  The point of interest in this plot is the
##  effect on the estimated local Gaussian cross-spectra as the point
##  v varies along the diagonal.

#####------------------------------------------------------------#####

##  In order for this script to work, it is necessary that the script
## '2_Data.R' (for P2_fig_02) has been used first.
...
##  scripts has been used without modifications and the code below
...
..TS  <- "dmt_bivariate_10b7b108a597d6c54a0ab04dc7e36ff9"
..Approx <- "Approx__1"

##  Select what kind of plot that should be produced.

.plot_type <- "Polar"  ## "Cartesian"

if (.plot_type  == "Cartesian") {
    ..S_type_pair <- c("LS_c_Co", "LS_c_Quad")
    .save_file_name <- "P2_fig_02.pdf" ## Co- and Quad-spectra
} else {
