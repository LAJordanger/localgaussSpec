###----------------------------------------------------------------###
##  The cGARCH-example from P2_fig_12.

##  This scripts investigates the local Gaussian cross-spectra based
##  on a multivariate GARCH-type model fitted to the log-returns of
##  the EuStockMarkets-data, focusing on the variables corresponding
##  to the original DAX and CAC variables.

###----------------------------------------------------------------###

##  In order for this script to work, it is necessary that the script
## '2_Data.R' from P2_fig_11 has been used first.
...
..TS <- "sample_rmgarch_3ba0572c315f69b5b54c81752ff6068c"
..Approx <- "Approx__1"
...
pushViewport(viewport(
    layout = grid.layout(3, length(..plot[[1]]))))
