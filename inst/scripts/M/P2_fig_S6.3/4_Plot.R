###----------------------------------------------------------------###
##  The "local trigonometric" example from P2_fig_S6.3.

##  This script investigates the local Gaussian cross-spectra for a
##  "bivariate local trigonometric" example, with a common phase shift
##  for all the four cosine-components.  Inspection for non-diagonal
##  points.

###----------------------------------------------------------------###

##  In order for this script to work, it is necessary that the script
## '2_Data.R' from P2_fig_03 has been used first.
...
..main_dir <- c("~", "LG_DATA_scripts", "P2_fig_03.S6.3")
...
.point_list <- list(
    '10_50' = list(levels_Horizontal = 1L,
                 levels_Vertical = 2L),
    '10_90' = list(levels_Horizontal = 1L,
                   levels_Vertical = 3L),
    '50_90' = list(levels_Horizontal = 2L,
                   levels_Vertical = 3L))
...
##  of the same type, and that should alose be based on the smallest
