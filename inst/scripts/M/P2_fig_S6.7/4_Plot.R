...
##  "bivariate local trigonometric" with a common phase shift for all
##  the four cosine-components.  Inspection at point in extreme lower
##  tail.
...
..TS <- "dmt_bivariate_67cced467f2a10c59a6833285e6b3e4b"
..Approx <- "Approx__1"
...
.point_list <- list(
    '01_01' = list(levels_Horizontal = 1L,
                 levels_Vertical = 1L))
