...
##  as the point v varies along the diagonal.  This example differs
##  from P1_fig_08 since it only consider points in the lower tail.
...
..TS  <- "dmt_de89eb62d39c815b116675e1605cb8c6"
..Approx <- "Approx__1"
...
##  Adjust the limit for the plot.

distance_plot <- distance_plot +
    coord_cartesian(xlim = c(0,0.035))
