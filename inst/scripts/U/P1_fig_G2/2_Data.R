...
##  This example investigates the effect of changing the point along
##  the diagonal, and it differs from P1_fig_08 since it only consider
##  points in the lower tail. The file "4_Plot.R" will based on this
##  create a combined heatmap and distance plot, that can be used to
##  search for the elusive C1-component that only occurs with
##  probability 0.05
