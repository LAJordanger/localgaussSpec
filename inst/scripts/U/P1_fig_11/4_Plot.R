...
##  This scripts investigates the local Gaussian auto-spectra for an
##  apARCH(2,3)-model fitted to the pseudo-normalised version of the
##  dmbp-data.
...
..TS <- "rugarch_3e08382d945f0567d9f8f5d8e171aa53"
...
.TS_annotation <- annotated_text$center$annotated_df["v_value", ]
