...
#' NB: This case: 200 lags, b=0.6, only points on the diagonal,
#' computed in order to give an argument related to the selection of
#' the blocklength.
...
## structure(c("14a56d251e5eceb427c4118789644916", "Approx__7", 
