#' An example testing one cosine with a bit of white noise.
...
.TS_sample <- TS_sample(
    ...
    theta = NULL,
    ## wn = NULL,
    wn = list(type = "rnorm", args = list(mean = 0, sd = .75), adjust = 0),
    .seed = NULL)
...
## structure(c("dmt_35af0d822d4cd79da5e2639334bb3022", "Approx__1", 
